...
echo "Importing tags and categories..."
python3 manage.py import_tags_and_categories

echo "Populating initial resources data..."
python3 manage.py import_initial_resources
...
echo "Running worker..."
python3 manage.py runworker video-upload &

echo "Running daphne..."
daphne service.asgi:application -v 2 --ws-protocol "graphql-ws" --proxy-headers --access-log=- -b 0.0.0.0 -p 8000 &
