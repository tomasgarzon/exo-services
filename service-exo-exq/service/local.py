...
SERVICE_NAME = os.environ.get('SERVICE_NAME', 'service-exo-exq')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'service_exo_exq'),
...
# 10: celery-exo-service-exq
# 15: django-channels

REDIS_HOST = os.environ.get('REDIS_HOST', 'redis')
REDIS_PORT = os.environ.get('REDIS_PORT', 6379)
REDIS_AUTH_DB = 0
REDIS_CELERY_DB = 12    # Define Redis database number
REDIS_CHANNELS_DB = 15

# Nginx

FORCE_SCRIPT_NAME = os.environ.get('FORCE_SCRIPT_NAME', '/exq/')
