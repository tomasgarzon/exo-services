...
SERVICE_NAME = os.environ.get('SERVICE_NAME', 'service-exo-companies')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'service_exo_companies'),
...
# 3: celery-exo-service-jobs
# 4: celery-exolever-test
# 5: celery-exo-service-companies
...
FORCE_SCRIPT_NAME = os.environ.get('FORCE_SCRIPT_NAME', '/companies/')
