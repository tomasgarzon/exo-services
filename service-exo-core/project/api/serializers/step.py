...
from project.api.serializers.step_rating import Rating, RatingSerializer
from team.api.serializers.team import TeamStepSerializer
...
class StepListSerializer(serializers.ModelSerializer):
    ...
    def get_has_assignments(self, obj):
        ...
        return obj.has_team_assignments(team)
...
class StepDetailSerializer(serializers.ModelSerializer):
    ...
    def get_team(self, obj):
        team = self.context.get('view').team
        return TeamStepSerializer(team).data
