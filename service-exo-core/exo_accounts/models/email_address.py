...
from ..utils.util import build_context_dict, get_site
...
class EmailAddress(TimeStampedModel):
    ...
    type_email = models.CharField(
        max_length=1,
        default=settings.EXO_ACCOUNTS_CH_PERSONAL_EMAIL,
        choices=settings.EXO_ACCOUNTS_CH_TYPE_EMAIL)
