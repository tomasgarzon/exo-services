...
class AssignmentStepAdmin(admin.ModelAdmin):
    list_display = ('project', 'step', 'name', 'order', 'streams', 'created_by')


class InformationBlockAdmin(admin.ModelAdmin):
    list_filter = ('type',)
    list_display = ('pk', 'type', 'content_type', 'content_object', 'title', 'subtitle', 'order', 'created_by')


class AssignmentTextAdmin(admin.ModelAdmin):
    list_display = ('block', 'text', 'created_by')


class AssignmentAdviceItemAdmin(admin.ModelAdmin):
    list_display = ('assignment_advice', 'description', 'order', 'created_by')


class AssignmentTaskItemAdmin(admin.ModelAdmin):
    list_display = ('pk', 'project', 'step', 'assignment_task', 'name', 'order', 'created_by')


class AssignmentStepTeamAdmin(admin.ModelAdmin):
    list_display = ('project', 'assignment_step', 'team', 'stream_display', 'created_by')
...
class AssignmentTaskTeamAdmin(admin.ModelAdmin):
    list_display = ('assignment_step_team', 'assignment_task_item', 'status', 'team', 'created_by')
