...
from forum.api.serializers.post import PostCreateSerializer
...
class ForumCircleViewSet(
    ...
    def list(self, request, *args, **kwargs):
        ...
        if filter_status != settings.CIRCLES_PARAM_STATUS_CH_NOT_SUBSCRIBED:
            ...
            if user.is_superuser or user.has_certified_role(settings.EXO_ROLE_CODE_CERTIFICATION_FOUNDATIONS):
