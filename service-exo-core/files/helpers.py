...
UPLOADED_FILE_VERSIONED_MIMETYPE = {
    ...
    settings.ASSIGNMENT_CH_RESOURCE_ITEM_TYPE_DOC: [
...
DEFAULT_MIMETYPE = settings.ASSIGNMENT_CH_RESOURCE_ITEM_TYPE_DOC
