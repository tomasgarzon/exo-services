...
class UploadedFileCreateView(UploadedFileViewMixin, CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        url_version = serializer.validated_data.pop('url')
        status_version = serializer.validated_data.pop('filestack_status')

        instance = serializer.save(
            created_by=self.request.user,
            related_to=related_instance,
            filestack_url=url_version,
            filestack_status=status_version,
        )
        return instance
