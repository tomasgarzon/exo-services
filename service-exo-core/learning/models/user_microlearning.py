...
class UserMicroLearning(ChoicesDescriptorMixin, TimeStampedModel):
    ...
    responses = JSONField(blank=True, null=True, default=list)
    ...
    class Meta:
        verbose_name = 'User MicroLearning'
        verbose_name_plural = 'User Microlearnings'
    ...
    @property
    def project(self):
        return self.microlearning.step_stream.project
    ...
    def add_typeform_response(self, score, response):
        ...
        self.save(
            update_fields=[
                'responses', 'status', 'modified', 'score',
            ],
        )
