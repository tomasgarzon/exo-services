...
SERVICE_NAME = os.environ.get('SERVICE_NAME', 'service-exo-events')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'service_exo_events'),
...
# 9: celery-exo-service-projects
# 10: celery-exo-service-events
...
FORCE_SCRIPT_NAME = os.environ.get('FORCE_SCRIPT_NAME', '/events/')
...
SERVICE_WEBSITE_HOST = os.environ.get('SERVICE_WEBSITE_HOST', '/website/')
