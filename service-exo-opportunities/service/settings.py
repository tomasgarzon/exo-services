...
AUTH_USER_PERMS_MARKETPLACE_FULL = 'view_marketplace_full'
AUTH_USER_PERMS_MARKETPLACE_FULL_PERMISSION_REQUIRED = 'auth_uuid.view_marketplace_full'

AUTH_USER_ALL_PERMISSIONS = (
    (AUTH_USER_PERMS_MARKETPLACE_FULL, 'Can view Marketplace'),
)
