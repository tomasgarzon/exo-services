...
SERVICE_NAME = os.environ.get('SERVICE_NAME', 'service-exo-opportunities')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'service_exo_opportunities'),
...
FORCE_SCRIPT_NAME = os.environ.get('FORCE_SCRIPT_NAME', '/opportunities/')
