...
SERVICE_NAME = os.environ.get('SERVICE_NAME', 'service-exo-projects')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'service_exo_projects'),
...
FORCE_SCRIPT_NAME = os.environ.get('FORCE_SCRIPT_NAME', '/projects/')
...
PLACE_TIMEZONE_URL = os.environ.get('PLACE_TIMEZONE_URL', '')
