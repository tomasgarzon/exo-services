...
class EmailAddressTest(TestCase):
    ...
    def test_authentication_with_new_email_pending(self, mock_send_verification):
        ...
        response_login = client.login(
            username=email_address.email,
            password='12456')
        self.assertFalse(response_login)
    ...
    def test_change_email(self, mock_send_verification):
        ...
        self.assertEqual(
            response[1],
            settings.EXO_AUTH_VALIDATION_CHOICES_NOT_VERIFIED)
        ...
        self.assertEqual(
            response[1],
            settings.EXO_AUTH_VALIDATION_CHOICES_VERIFIED)
        ...
        self.assertEqual(
            response[1],
            settings.EXO_AUTH_VALIDATION_CHOICES_OTHER_USER)
