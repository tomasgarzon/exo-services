...
SERVICE_NAME = os.environ.get('SERVICE_NAME', 'service-exo-auth')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'service_exo_auth'),
...
# 4: celery-exo-service-conversations
# 7: celery-exo-service-auth
...
FORCE_SCRIPT_NAME = os.environ.get('FORCE_SCRIPT_NAME', '/exo-auth/')
