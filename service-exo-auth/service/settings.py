...
AUTH_USER_MODEL = 'exo_auth.User'

AUTHENTICATION_BACKENDS = (
    'exo_auth.backends.MultiEmailAuthenticationBackend',
    'exo_auth.backends.MasterDirectoryBackend',
...
CELERY_SERVICE_BROKER_URL = 'redis://{}:{}/{}'.format(
    REDIS_HOST, REDIS_PORT, REDIS_CELERY_DB)
