...
class OpportunityRequesterLeaveFeedbackReminderMailView(BaseMailView):
    """
    """
    template_name = 'mails/opportunity/opportunity_requester_leave_feedback_reminder.html'
